define([
    ...
    "backbone.radio",
    "radio.shim",
    "text!assets/typeahead/templates/typeahead.html",
    "text!assets/typeahead/templates/optiontemplate.html"
    ...
    var TypeAheadConstructor = function(channelName){
        ...
        TypeAhead.on("start", function(options){
            ...
            console.log("TypeAhead.optionArrayPool: ", TypeAhead.optionArrayPool);
